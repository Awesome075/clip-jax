...
from modeling import CLIPTextConfig, CLIPVisionConfig, CLIPModel
from flax import nnx, serialization, traverse_util

def load_flax_weights(clip_model, msgpack_path="flax_model.msgpack"):
